...
%In Fig. \cite{DAS_workflow} we show DAS workflow diagram.
%\begin{figure}[htb]
%\centering
%\includegraphics[width=120mm]{DAS_workflow.pdf}
%\caption{
%The DAS workflow diagram.
%}
%\label{DAS_workflow}
%\end{figure}
%The input query is recorded into logging DB and parsed by the DAS parser.
