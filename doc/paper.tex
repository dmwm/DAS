...
\verb+get_data+ and \verb+parser+ are define method to fetch and parse
data, respectively.
...
is a key which identify the record defined in Mapping DB, e.g. for 
\verb+file+ record it is a \verb+file.name+.
