...
upon the user request. Each plugin was responsible for invoking
data-service APIs and parsing retrieved data into the DAS data format
suitable for storage, JSON. Although the majority of data-services looks alike
...
in aforementioned example, using {\it file} in DAS query cause invokation of DBS 
...
For instance, users were able to type {\it run > 10 and run < 100}
