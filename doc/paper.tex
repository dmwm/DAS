...
the most popular query requests.
}
\label{DAS_cache}
\end{figure}
...
DAS (total) & JSON & 388108 & 234 sec & 2.05/50.7 sec \\
\hline
\hline
\end{tabular}
...
The last row shows aggregated results and total time
spent in all components (DBS+PhEDEx+aggregation).
