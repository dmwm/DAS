...
class SqlDASLexer(Lexer):
    ...
    def mKW(self, ):
        ...
        try:
            ...
            # SqlDAS.g:50:4: ( ( 'a' .. 'z' | '0' .. '9' | 'A' .. 'Z' | '-' | '_' | ':' | '#' | '/' | '*' | '%' ) ( 'a' .. 'z' | '0' .. '9' | 'A' .. 'Z' | '.' | '-' | '_' | ':' | '#' | '/' | '*' | '%' | '&' )* )
            # SqlDAS.g:50:6: ( 'a' .. 'z' | '0' .. '9' | 'A' .. 'Z' | '-' | '_' | ':' | '#' | '/' | '*' | '%' ) ( 'a' .. 'z' | '0' .. '9' | 'A' .. 'Z' | '.' | '-' | '_' | ':' | '#' | '/' | '*' | '%' | '&' )*
            pass 
    ...
    DFA2_transition = [
        DFA.unpack(u"\2\41\2\uffff\1\41\22\uffff\1\41\1\37\1\uffff\1\31\1"
        u"\uffff\1\31\1\40\1\uffff\1\3\1\4\1\31\1\uffff\1\32\1\31\1\33\14"
        u"\31\1\uffff\1\35\1\36\1\34\2\uffff\1\13\1\17\1\26\1\30\1\31\1\11"
        u"\2\31\1\21\2\31\1\25\1\31\1\23\1\15\3\31\1\7\3\31\1\5\3\31\4\uffff"
        u"\1\31\1\uffff\1\12\1\16\1\1\1\27\1\31\1\10\2\31\1\20\2\31\1\24"
        u"\1\31\1\22\1\14\3\31\1\2\3\31\1\6\3\31"),
        DFA.unpack(u"\1\42"),
