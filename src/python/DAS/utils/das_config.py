...
DAS_OPTIONS = [
    ...
    # cherrypy parameter, controls number of pending request in socket queue
    ...
    # In CMS we can adjust input values identifying certain input patterns
    # like dataset/release/site... values.
