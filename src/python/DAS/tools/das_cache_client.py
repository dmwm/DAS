...
"""
__revision__ = "$Id: das_cache_client.py,v 1.2 2009/05/28 18:59:11 valya Exp $"
...
if __name__ == '__main__':
    ...
    #print "DELETE"
    #data = httplib_request(host, path, params, request, debug=1)
    #print data
    #data = urllib2_request('http://'+host+path, params)
    #print data
