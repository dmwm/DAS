...
class testDASQuery(unittest.TestCase):
    ...
    def test_query_initialization(self):
        ...
        nquery = DASQuery(dquery.storage_query)
        self.assertEqual(iquery, nquery.storage_query.get('uinput'))
    ...
    def test_query_records(self):
        ...
        iquery = 'records'
        dquery = DASQuery(iquery)
        expect = dict(fields=None, spec={}, uinput=iquery)
    ...
    def test_query_properties(self):
        ...
        self.assertEqual(True, query.unique_filter)
    ...
    def test_query_str_repr(self):
        ...
        msg = "<query='''%s''' instance=%s qhash=%s>" \
                % (iquery, dasquery.instance, dasquery.qhash)
